...
text:
  `<div class = "container-fluid">
   <div class = "row align-items-center">
    ...
    <p>
      Versions of the game before 0.75 don't support the D-pad on controllers that also use sticks (though <a href="https://github.com/AntiMicro/antimicro">AntiMicro</a> is a workaround). Be sure to update to the latest version if you prefer to use the D-pad for movement.
    </p>
...
mechDict["mission"] = {
  ...
  <article class=" col-12 ">
    ...
    <ul>
      ...
      <li><strong>Shop Duty</strong>: An ally will be able to manage the shop automatically, but you're still responsible for choosing which items to put up for sale. Additionally, if you have the lead character open up shop while someone is on shop duty, the two will work together to boost sales. However, the lead character will get most of the EXP.</li>
      ...
      <li><strong>Cooking Duty</strong>: This is similar to alchemy, only the assigned character will make a random food item. All characters have their own list of possible food items, and some items can only be obtained through cooking duty.</li>
    </ul>
  </article>
  </div>
  </div>`
